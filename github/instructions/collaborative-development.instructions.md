...
This workflow applies across all development tasks and ensures that:
- Developer maintains decision-making control
- Implementation aligns with project requirements
- Changes are well-understood before execution
